...
/**
 * Generated class for the PreguntasLab3Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-preguntas-lab3',
  templateUrl: 'preguntas-lab3.html',
})
export class PreguntasLab3Page {
  public x;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PreguntasLab3Page');
  }
